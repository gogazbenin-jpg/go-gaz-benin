    ...
    <div className="min-h-screen bg-[#F5F5F5] pb-8">
      <div className="flex flex-col items-center px-6 pb-6 pt-12">
        <div className="relative mb-3">
          ...
          <button className="absolute -bottom-1 -right-1 flex h-7 w-7 items-center justify-center rounded-full bg-accent text-accent-foreground shadow-md">
            <Camera size={14} />
          </button>
        </div>
      ...
      <div className="space-y-0">
        ...
        <div className="mx-4 mt-4">
          <button onClick={handleLogout}
            className="flex w-full items-center justify-center gap-2 rounded-2xl border border-destructive bg-card py-3.5 text-destructive shadow-sm active:bg-destructive/10">
            <LogOut size={18} />
