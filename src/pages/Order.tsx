...
const products = [
  { id: "6kg", label: "Bouteille 6kg", price: 5500, weight: "6 kg", size: "6kg" as const },
  { id: "12kg", label: "Bouteille 12kg", price: 11000, weight: "12 kg", size: "12kg" as const },
  { id: "25kg", label: "Bouteille 25kg", price: 22000, weight: "25 kg", size: "25kg" as const },
];
        ...
        <div className="mb-6 flex flex-col gap-3">
          {products.map((product) => (
            <button key={product.id} onClick={() => setSelected(product.id)}
              ...
              <div className="flex-shrink-0"><GasBottle brandId={selectedBrand} size={product.size} /></div>
              ...
              <div className="text-right flex-shrink-0">
                ...
                <p className="text-[10px] font-medium text-[#27AE60]">Prix TTC</p>
              </div>
            </button>
          ))}
        </div>
